...
$mensaje[FORMULARIO_OK] = "Formulario correcto.";
$mensaje[FORMULARIO_KO_NOMBRE_MAIL_OBLIGATORIO] = "El nombre y el mail son obligatorios.";
$mensaje[FORMULARIO_KO_RECAPTCHA] = "Error de seguridad en la validación del Recaptcha.";
