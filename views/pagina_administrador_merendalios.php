...
echo '
			...
			<div class="form-bottom">
				<form role="form" action="./editar_producto" enctype="multipart/form-data" method="post"
					...
					<div class="form-group">
						<label><span>* </span>Título viejo</label> <input type="text"
							name="titulo_producto" class="titulo_producto" required="required" />
					</div>
					
					<div class="form-group">
						<label>Título nuevo</label> <input type="text"
							name="titulo_producto_nuevo" class="titulo_producto_nuevo" required="required" />
					</div>
					...
					<div class="form-group">
						<label>Listado nuevo</label> <input type="checkbox" name="listado_edicion" id="check_edicion" value="listado"
						onchange="javascript:showContent()">
					</div>
