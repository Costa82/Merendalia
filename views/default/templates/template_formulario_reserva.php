	...
	<form action="./formulario_reserva" method="post"
		...
		<div class="form condiciones">
			<input type="checkbox" name="condiciones" id="condiciones"><label>Acepta
				la <a href="politica_privacidad_y_proteccion_datos"
				title="Aviso Legal"><i>Política de privacidad y Protección de datos</i></a>
			</label>
		</div>
		...
		<div class="texto_legal_formulario">
			...
			<p>
				...
				como se explica en nuestra <a
					href="politica_privacidad_y_proteccion_datos"
