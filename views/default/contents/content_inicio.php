...
<div class='google'>
	...
	<div class='google_flex'>
		...
		<div class='resenas_google'>
			...
			<a href='https://supple.live/8nN4UVRkRp32hhWu9' target="_blank">
				...
				<p class="bocadillo">"Ha sido una grata sorpresa descubrir
					Merendalia. Un espacio perfecto para celebrar cualquier tipo de
					evento. Sin duda un gran acierto poder celebrar allí mis 50! En
					este caso eramos unas 30 personas, incluido un Photocoll. Es
					céntrico y bien comunicado, el local está decorado con buen gusto.
					El trato por parte de los propietarios ha sido excelente. Todo han
					sido facilidades. El catering es casero y riquísimo (tortillas y
					empanadas) ya que el resto lo llevamos nosotros. El hecho de que
					tenga cocina para poder preparar comida, creo que es un plus para
					el local. Te hace sentir como en casa. Lo pasamos genial. Sin duda
					lo tendremos en cuenta para la siguiente."</p>
	...
	<p class="leer_mas">
		Si quieres leer más , <a href='https://supple.live/8nN4UVRkRp32hhWu9'
