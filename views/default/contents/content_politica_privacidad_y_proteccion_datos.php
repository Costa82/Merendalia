...
<div class='contenedor_texto avisoLegal'>
	...
	<p>En el marco de la relación de prestación de servicios en el ámbito
		...
		de Carácter Personal (en adelante, LOPD), del Real Decreto 1720/2007,
		de 21 de diciembre, por el que se aprueba el Reglamento de desarrollo
		de la misma, así como en el Reglamento (UE) 2016/679 del Parlamento
		...
		de datos personales, por el que se deroga la directiva 95/46/CE (en
		adelante, RGPD) y de la Ley 34/2002, de 11 de julio, de servicios de
		la sociedad de la información y de comercio electrónico (en adelante,
		LSSI-CE), MERENDALIA C.B garantiza la protección y confidencialidad de
		los datos personales, de cualquier tipo que nos proporcionen nuestros
		clientes, de acuerdo con lo dispuesto en el Reglamento General de
	...
	<p>Los datos facilitados serán tratados en los términos establecidos en
		el RGPD, en este sentido MERENDALIA C.B ha adoptado los niveles de
	...
	<p>b) Interés legítimo: Para atender a las consultas y reclamaciones
		que nos plantee y para gestionar el cobro de las cantidades adeudadas.</p>
	...
	<p>
		...
		para ninguna de las finalidades indicadas. </br> </br> </br>
	...
	<p>
		...
		hora de determinar el oportuno periodo de conservación, examinamos los
		riesgos que conlleva el tratamiento, así como nuestras obligaciones
		contractuales, legales y normativas, las políticas internas de
		conservación de datos y nuestros intereses de negocio legítimos
		descritos en el presente Aviso de Privacidad y Política de Cookies. </br>
	...
	<p>
		...
		y a accesos, tratamientos o revelaciones no autorizados, habida cuenta
		del estado de la tecnología, la naturaleza y los riesgos a que están
		expuestos los datos. No obstante, no podemos responsabilizarnos del
		uso que Ud. haga de los datos (incluido usuario y contraseña) que
	...
	<p>a) Derecho de acceso a sus datos personales, para saber cuáles están
	...
	<p>En caso de que entienda que sus derechos han sido desatendidos por
		...
		de Protección de Datos, a través de alguno de los medios siguientes:</p>
...
<div class='contenedor_texto avisoLegal'>
	...
	<p>
		En la web <strong>http://www.merendalia.es/</strong> (en adelante, el
		Sitio Web) utilizamos cookies para facilitar la relación de los
		visitantes con nuestro contenido y para permitir elaborar estadísticas
		sobre las visitantes que recibimos.
	</p>
	...
	<p>Se denominan cookies a unos pequeños archivos que se graban en el
		...
		identificarle a usted como un usuario determinado que ya visitó la web
		con anterioridad, visualizó determinadas páginas, etc. y además
		permite guardar sus preferencias personales e información técnica como
		por ejemplo las visitas realizadas o páginas concretas que visite.</p>

	</br>
	<p>En cumplimiento de la Directiva 2009/136/CE, desarrollada en nuestro
		ordenamiento por el apartado segundo del artículo 22 de la Ley de
		Servicios de Sociedad de la Información, siguiendo las directrices de
		la Agencia Española de Protección de Datos, procedemos a informarle
		detalladamente del uso que se realiza en nuestra web.</p>
	...
	<p>
		<strong>Tipos de cookies según la entidad que las gestiona</strong>
	</p>

	</br>
	<p>- <u>Cookies propias:</u> Son aquéllas que se envían al equipo terminal del
		usuario desde un equipo o dominio gestionado por el propio editor y
		desde el que se presta el servicio solicitado por el usuario.</p>
	<p>- <u>Cookies de terceros:</u> Son aquéllas que se envían al equipo terminal
		del usuario desde un equipo o dominio que no es gestionado por el
		editor, sino por otra entidad que trata los datos</p>

	</br> </br>
	<p>
		<strong>Tipos de cookies según el plazo de tiempo que permanecen
			activas</strong>
	</p>

	</br>
	<p>- <u>Cookies de sesión:</u> Son un tipo de cookies diseñadas para recabar y
		almacenar datos mientras el usuario accede a una página web.</p>
	<p>- <u>Cookies persistentes:</u> Son un tipo de cookies en el que los datos
		...
		puede ir de unos minutos a varios años.</p>

	</br> </br>
	<p>
		<strong>Tipos de cookies según su finalidad</strong>
	</p>

	</br>
	<p>- <u>Cookies técnicas:</u> Aquéllas que permiten al usuario la navegación a
	...
	<p>- <u>Cookies de personalización:</u> Son aquéllas que permiten al usuario
	...
	<p>- <u>Cookies publicitarias:</u> Son aquéllas que permiten la gestión, de la
	...
	<p>- <u>Cookies de publicidad comportamental:</u> Son aquéllas que permiten la
	...
	<p>- <u>Cookies de análisis:</u> Son aquéllas que permiten al responsable de
		las mismas, el seguimiento y análisis del comportamiento de los
		usuarios de los sitios web a los que están vinculadas. La información
	...
	<p>Respecto al tratamiento de datos recabados a través de las cookies
		...
		consentimiento informado para su uso, es poco probable que representen
		un riesgo para la privacidad de los usuarios siempre que se trate de
		cookies de primera parte, que traten datos agregados con una finalidad
		estrictamente estadística, que se facilite información sobre sus uso y
		se incluya la posibilidad de que los usuarios manifiesten su negativa
		sobre su utilización.</p>
	...
	<p>La aceptación realizada por el usuario, haciendo click en el botón
		...
		que está consintiendo expresamente al responsable para su utilización,
		pudiendo ejercer sus derechos y revocar su consentimiento en cualquier
		momento, a través de solicitud a MERENDALIA CB.</p>

	</br>
	<p>A continuación, le informamos detalladamente todas las cookies que
		podrían llegar a instalarse desde nuestro sitio web. En función de su
		navegación, de la configuración de su navegador y de la aceptación o
		rechazo de las mismas, podrán instalarse todas o sólo algunas de
		ellas.</p>

	</br>
	<table class="table_cookies">
		<tr>
			<th>Cookie</th>
			<th>Origen</th>
			<th>Finalidad y más información</th>
		</tr>
		<tr>
			<td>_gid</td>
			<td>Terceros</td>
			<td>Google Analytics: Se usa para distinguir a los usuarios. 24
				horas, de sesión.</td>
		</tr>
	</table>
	...
	<p>
		<strong>Nota informativa:</strong> La cookie que aparece en la tabla
		es solo un ejemplo. La persona o empresa encargada del mantenimiento
		de tu web será quien deba actualizarlo con las cookies que realmente
		utilices en la página.
	</p>
	...
	<p>Su navegador también puede incluir la posibilidad de seleccionar con
	...
	<p>Para permitir, conocer, bloquear o eliminar las cookies instaladas
		en su equipo puede hacerlo mediante la configuración de las opciones
		del navegador instalado en su ordenador.</p>

	</br>
	<p>Puede encontrar información sobre cómo configurar los navegadores
		más usados en las siguientes ubicaciones:</p>

	</br>
	<p>- <u>Internet Explorer:</u> Herramientas -> Opciones de Internet ->
		Privacidad -> Configuración. Para más información, puede consultar el
		soporte de Microsoft o la Ayuda del navegador.</p>
	<p>- <u>Firefox:</u> Herramientas -> Opciones -> Privacidad -> Historial ->
		Configuración Personalizada. Para más información, puede consultar el
		soporte de Mozilla o la Ayuda del navegador.</p>
	<p>- <u>Chrome:</u> Configuración -> Mostrar opciones avanzadas -> Privacidad
		-> Configuración de contenido. Para más información, puede consultar
		el soporte de Google o la Ayuda del navegador.</p>
	<p>- <u>Safari:</u> Preferencias -> Seguridad. Para más información, puede
		consultar el soporte de Apple o la Ayuda del navegador.</p>

	</br>
	<p>
		Si ha aceptado cargar las cookies de Google Analytics, también puede
		revocar en cualquier momento dicha aceptación utilizando el <i>"Complemento
			de inhabilitación para navegadores de Google Analytics"</i>,
		accediendo a la siguiente página web y siguiendo las instrucciones que
		ahí se detallan: <a href="https://tools.google.com/dlpage/gaoptout?hl=es">https://tools.google.com/dlpage/gaoptout?hl=es</a>
	</p>
