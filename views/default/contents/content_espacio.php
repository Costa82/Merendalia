...
<div class='contenedor_reservas'>
	...
	<div class='texto_descriptivo'>
		...
		<p>En merendalia queremos que todas tus reservas giren en torno a la
			mesa. ¿Qué sería de nuestras reuniones sin la comida y la bebida como
			protagonistas? Podeis traeros las cosas de casa, encargarnoslo a
			nosotros o una combinación de ambas.</p>
		</br>
		<p>
		...
		<ul>
			<li>- Puedes traerlo todo hecho de casa o usar la cocina equipada
				para preparar lo que os apetezca y hacer en Merendalia, ¡una jornada
		...
		<ul>
			<li>- <u>Picoteo:</u> Te preparamos un picoteo, almuerzo, merienda...
				Empanadas, canapés, tortillas, ensaladas, embutidos, quesos,
				postres...</br> Visita la sección <a href='catering'>cátering</a> y
				ve algunos de nuestros productos en la <a href='galeria'>galería</a>
				de imágenes.</li>
			<li>- <u>Menús ¡Calentar y Listo!</u>: Se prepara un menú completo.
				...
				segundo plato. Entrantes, ensaladas, postres, cafés, chupitos… No os
				preocupeis por nada, ¡todo listo! Llamádnos y os informaremos de
